...
const ProjectWorkspace: React.FC<ProjectWorkspaceProps> = ({ project }) => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { id: '1', sender: 'ai', text: `Hello! I'm Metrrik, your AI assistant for this project. How can I help you with "${project.name}" today? You can ask for a cost estimate, a draft proposal, or anything else.` }
  ]);
